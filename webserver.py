...
class webServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            # if self.path.endswith("/item/new"):
            ...
            if self.path.endswith("/catagories"):
                catagories = session.query(Catagory).all()
                # output = ""
                # # Objective 3 Step 1 - Create a Link to create a new menu item
                # output += "<a href = '/item/new' > Make a New Item Here </a></br></br>"
                ...
                for catagory in catagories:
                    output += <a href = '/catagroies/%s/items' > catagory.name
                    output += "</br>"
...
def main():
    try:
        ...
        print 'Web server running...open localhost:8000/catagories in your browser'
